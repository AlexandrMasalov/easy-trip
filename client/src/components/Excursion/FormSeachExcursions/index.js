...
import {
  Form, Select, Button, DatePicker, Col,
} from 'antd';
...
import './FormSearchExcursion.scss';
...
export default function FormSeachExcursions() {
  ...
  const onFinish = (values) => {
    ...
    // console.log(values, '++++++++++++++++++++++++++++++++++++++++++++++');
    // console.log(values.date.date._d, '++++++++++++++++++++++++++++++++++++++++++++++');
    if (!date?._d) {
      console.log('NO DATE<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<=============');
  ...
  return (
    ...
    >
      ...
      <Form.Item>
        <Button type="primary" htmlType="submit" size="large" style={{ boxShadow: '0px 5px 10px 2px rgba(34, 60, 80, 0.2)', textAlign: 'left' }}>
          Найти
        </Button>
      </Form.Item>
    </Form>
