  ...
  return (
    <Row justify="center">
      <Form
        ...
        style={{ padding: 50, marginBottom: 30 }}
        name="complex-form"
        layout="inline"
        onFinish={onFinish}
        labelCol={{ span: 2 }}
      ...
      >
        <Input.Group compact>
          ...
          <Form.Item name="datefrom">
            <DatePicker placeholder="Когда" locale={locale} allowClear="false" size="large" style={{ boxShadow: '0px 5px 10px 2px rgba(34, 60, 80, 0.2)', marginRight: 10, textAlign: 'left' }}  />
          </Form.Item>

          <Form.Item name="dateto">
            <DatePicker placeholder="Обратно" locale={locale} allowClear="false" size="large" style={{ boxShadow: '0px 5px 10px 2px rgba(34, 60, 80, 0.2)', marginRight: 10  }} />
          </Form.Item>
